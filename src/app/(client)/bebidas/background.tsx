...
const Background = () => {
  ...
  return (
    ...
    <div className='w-screen h-screen grid grid-cols-3 place-items-center overflow-hidden fixed top-0 left-0 -z-10'>
        ...
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 -rotate-45" />
        <div></div>
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 rotate-12"/>
        <div></div>
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 rotate-45"/>
        <div></div>
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 "/>
        <div></div>
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 -rotate-45"/>
        <div></div>
        <ProductImage src='https://res.cloudinary.com/deyofhj4o/image/upload/v1704765102/Sweet-Dolly/ofsqcoxqnsjcs4tczpp8.png' classname="w-20 rotate-45"/>
